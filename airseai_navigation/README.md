# airseai_navigation
**airseai_navigation provides a navigation service interface for mobile platforms, allowing them to receive 2D navigation commands and perform path planning and movement functions. This module integrates nav2_simple_commander. By analyzing path planning results and movement status, airseai_navigation can provide more detailed navigation status information.**

## airseai_navigation API Overview

1. Service
* `/airseai_navigation/navigate_to_pose`: Provides a service to execute navigation and return the status.
``` 
...
ros2 service call /airseai_navigation/navigate_to_pose airseai_interface/srv/AirseaiNav "{x: 8.5, y: 8.3, theta: 1.3}"
```
