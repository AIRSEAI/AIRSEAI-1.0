...
def generate_launch_description():
    ...
    nav_dir = get_package_share_directory('airseai_navigation')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map_yaml_file',
        default_value='/home/airsbot2/airseai/src/airseai/airseai_localization/map/map_sim.yaml',
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(nav_dir, 'config', 'neo_airsbot2_sim.yaml'),
