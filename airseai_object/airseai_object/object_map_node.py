...
from airseai_interface.srv import SaveObjectNavGoal
...
class ObjectMap(Node):
    def __init__(self):
        ...
        # Topics of publisher
        self.topic_pub_keyframe_cloud = self.config.get('topic_pub_keyframe_cloud', '/airseai_object/keyframe_cloud')
        self.topic_pub_keyframe_marker = self.config.get('topic_pub_keyframe_marker', '/airseai_object/keyframe_marker')
        self.topic_pub_object_marker = self.config.get('topic_pub_object_marker', '/airseai_object/object_marker')
        self.topic_pub_object_nav_goal_marker = self.config.get('topic_pub_object_nav_goal_marker', '/airseai_object/object_nav_goal_marker')
        self.topic_pub_object_segmentation = self.config.get('topic_pub_object_segmentation', '/airseai_object/object_segmentation')
        ...
        self.srv_save_object_nav_goal = self.create_service(SaveObjectNavGoal, '/airseai_object/save_object_nav_goal', self.callback_service_save_object_nav_goal)
        # Other objects
