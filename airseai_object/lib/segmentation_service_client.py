...
from airseai_interface.srv import SegmentationMapping
...
class SegmentationServiceClient(Node):
    def __init__(self, config_path, node_name='segmentation_service_clinet', namespace=''):
        ...
        self.path_label_table = self.config.get('path_label_table', '/home/airsbot2/airseai/src/airseai/airseai_perception/lib/configs/semantic_label_table.txt')
        self.request_timeout = self.config.get('request_timeout', 15.0)
        self.name_segmentation_service_server = self.config.get('name_segmentation_service_server', '/airseai_perception/SegmentationMapping')
