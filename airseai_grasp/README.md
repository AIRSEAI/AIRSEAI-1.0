...
![grasp_scene](doc/airseai_grasp.gif)
## Airseai_grasp API Overview
### grasp_server_node
* default config: airseai_grasp/config/airseai_grasp_config.yaml
1. Service
  * `/airseai_grasp/grasp_server`: Provides a service for the planner to invoke for picking object or placement.
  * `/airseai_perception/SegmentationGrasping`: Provides a service to the grasping node for acquiring object's mask.
2. Parameters
  ...
  * `model_checkpoint_path`: The path to the weight files for the GraspNet module.(Default: '/home/airsbot2/airsbot2_grasp/grasp_test/src/airseai_grasp/lib/Scale_Balanced_Grasp/logs/log_full_model/checkpoint.tar')
