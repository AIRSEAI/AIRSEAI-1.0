...
## airseai_perception API Overview
### airseai_perception_node
* Service
  * `airseai_perception/SegmentationGrasping`: Provides a service to provide grasping node with a mask for specified objects.
  * `airseai_perception/SegmentationMapping`: Provides a service to provide mapping node with the mask of the specified object.
