...
package_name = 'airseai_perception'
...
setup(
    ...
    description='airseai_perception',
    license='Apache 2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'seg_service_node = airseai_perception.seg_service_node:main',
            'service_test = airseai_perception.service_test:main',
        ],
    },
)
