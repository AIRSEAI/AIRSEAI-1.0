...
from airseai_interface.srv import SegmentationGrasping, SegmentationMapping
...
class SegmentationServiceServer(Node):
    def __init__(self, node_name="airseai_perception_server_node"):
        super().__init__(node_name=node_name)
        self.get_logger().info("airseai_perception_server_node initialization process started.")
        ...
        # Services
        self.seg2grasp = self.create_service(SegmentationGrasping, 'airseai_perception/SegmentationGrasping', self.segmentation_grasp_callback)
        self.seg2map = self.create_service(SegmentationMapping, 'airseai_perception/SegmentationMapping', self.segmentation_mapping_callback)
        ...
        self.get_logger().info("airseai_perception_server_node initialization process done.")
...
def main(args=None):
    ...
    server_node = SegmentationServiceServer("airseai_perception_server_node")
